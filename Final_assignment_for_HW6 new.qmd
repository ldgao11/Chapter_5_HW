...
## new session for Chapter 5

Download a dataset from a github account using import() function and run describe() from psych package.

```{r}
url = "https://github.com/yrosseel/lavaan/raw/master/data/Demo.twolevel.RData"

# Download data

disprop_data <- rio::import(url)
# remember you can also call the package using library  
